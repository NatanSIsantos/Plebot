...
'''
                # Saudações
listResponses = [[r'tarde|noite|dia|eae|ola|oi', " Saudações nobre cliente"],
                ...
                [r'quarto|hospedagem|dormir aqui|pra dormir|onde dormir', " Temos quartos para até duas pessoas!" 
                "\n         São duas peças de prata por noite... Uh... recomendo evitar o 505"],

                [r'como assim', " Você deve está ouvindo coisas..."],
                ...
                [r'bem|como vai|como esta', " Estaria melhor se você comprasse alguma coisa"],
                [r'como anda', " Com as pernas..."],
